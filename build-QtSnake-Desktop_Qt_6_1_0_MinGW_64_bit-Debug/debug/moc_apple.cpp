...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Apple_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Apple_t qt_meta_stringdata_Apple = {
    {
QT_MOC_LITERAL(0, 5) // "Apple"
...
const QMetaObject Apple::staticMetaObject = { {
    ...
    qt_meta_stringdata_Apple.offsetsAndSize,
    qt_meta_data_Apple,
    qt_static_metacall,
    nullptr,
    nullptr,
...
void *Apple::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Apple.stringdata0))
